  ...
  return (
    <div className="px-6">
      <section className="relative py-16 px-6 sm:px-10 overflow-hidden mb-[50px]">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-3xl shadow-2xl"></div>
            ...
            >
              {reviews.map((review, index) => (
                <motion.div
                  ...
                  className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border border-gray-200 dark:border-gray-700 rounded-2xl p-6 text-left shadow-lg hover:shadow-yellow-100/20 transition-all"
                >
                  {/* User Info */}
        ...
        <motion.div
          ...
          className="absolute top-10 left-10 w-72 h-72 bg-yellow-400 rounded-full blur-3xl"
        ></motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.1 }}
          ...
          className="absolute bottom-10 right-10 w-64 h-64 bg-gray-500 rounded-full blur-3xl"
        ></motion.div>
      </section>
    </div>
  );
